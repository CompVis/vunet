...
if __name__ == "__main__":
    ...
    parser.add_argument("--src_img", required = True, help = "path to src_img")
    parser.add_argument("--tar_img", required = True, help = "path to tar_img")
    parser.add_argument("--src_jo", required = True, help = "path to src_jo")
    parser.add_argument("--tar_jo", required = True, help = "path to tar_jo")
